                            ...
                            <div id="EditProfile" className="tab-pane active">
                                <div className="position-center">
									...
									<div className="row">
                                        <div className="col-md-6">
											<div className="select-style location-style form-control">
											  <select>
												<option value="" selected disabled>Enter City</option>
                                        ...
                                        <div className="col-md-6">
											<div className="reg-login-info">
												<input placeholder="Locality" type="text" required />
											</div>
										</div>
										<div className="col-md-6">
											<div className="reg-login-info">
												<input placeholder="Enter Sub-Location" type="text" required />
											</div>
										</div>
										<div className="col-md-6">
											<div className="reg-login-info">
												<input placeholder="Name Of Project" type="email" required />
											</div>
										</div>
                                        <div className="col-md-6">
											<div className="reg-login-info">
									...
									<div className="row">
										...
										<div className="col-md-6">
											<div className="reg-login-info">
												<input placeholder="Building Name" type="text" required />
											</div>
										</div>
										<div className="col-md-6">
											<div className="select-style form-control ">
											  <select>
												<option value="" selected disabled>Furnished Status</option>
									...
									<div className="row">
										...
										<div className="col-md-8">
											<div className="reg-login-info">
												<input placeholder="Covered Area" type="text" required />
											</div>
										</div>
										...
										<div className="col-md-8">
											<div className="reg-login-info">
												<input placeholder="Plot Area" type="text" required />
											</div>
										</div>
										<div className="col-md-4">
											<div className="select-style form-control ">
										...
										<div className="col-md-8">
											<div className="reg-login-info">
												<input placeholder="Carpet Area" type="text" required />
											</div>
										</div>
										<div className="col-md-4">
											<div className="select-style form-control ">
									...
									<div className="row">
										...
										<div className="col-md-6 share-space">
											...
											<div className="btn-group btn-group-horizontal" data-toggle="buttons">
												<label className="btn active">
												  <input type="radio" name='gender1' /><i className="fa fa-circle-o radiobutton-size"></i><i className="fa fa-dot-circle-o radiobutton-size"></i> <span>New Property</span>
												</label>
												<label className="btn">
										...
										<div className="col-md-6 share-space">
											...
											<div className="btn-group btn-group-horizontal" data-toggle="buttons">
												<label className="btn active">
												  <input type="radio" name='gender2' /><i className="fa fa-circle-o radiobutton-size"></i><i className="fa fa-dot-circle-o radiobutton-size"></i> <span>Under Construction</span>
												</label>
												<label className="btn">
									...
									<div className="row">
										...
										<div className="col-md-6">
											<div className="reg-login-info">
												<input placeholder="Expected Price : Enter Total Price $" type="text" required />
											</div>
										</div>
										<div className="col-md-6">
											<div className="reg-login-info">
												<input placeholder="Price Per Square Yard $" type="text" required />
											</div>
										</div>
										<div className="col-md-6">
											<div className="reg-login-info">
												<input placeholder="Other Charges $" type="text" required />
											</div>
										</div>
									</div>
									<div className="col-md-12">
