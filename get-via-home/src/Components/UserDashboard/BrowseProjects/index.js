			...
			<div className="col-md-12">
                    <ul className="breadcrumbs-alt">
                        <li>
                         ...
                         <li>
                            <a className="current" href="BrowseProjects">Browse Projects</a>
                        </li>
                      {/*   <li>
					...
					<div id="sb-search" className="sb-search sb-search-open">
						<form>
							
        
        <input placeholder="Enter your search term..."  type="text" id="search"  className="sb-search-input" />
